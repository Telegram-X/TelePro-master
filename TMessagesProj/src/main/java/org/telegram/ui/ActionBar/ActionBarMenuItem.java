...
public class ActionBarMenuItem extends FrameLayout {
    ...
    public TextView addSubItem(int id, String text, int icon) {
        ...
        if (icon != 0) {
            ...
            micon.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_chats_menuItemIcon), PorterDuff.Mode.SRC_ATOP));
            textView.setCompoundDrawablePadding(AndroidUtilities.dp(12));
            if (!LocaleController.isRTL) {
                textView.setCompoundDrawablesWithIntrinsicBounds(micon, null, null, null);
            } else {
                textView.setCompoundDrawablesWithIntrinsicBounds(null, null, micon, null);
            }
        }
