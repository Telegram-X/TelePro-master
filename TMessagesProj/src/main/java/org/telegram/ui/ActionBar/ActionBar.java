...
public class ActionBar extends FrameLayout {
    ...
    public void changeGhostModeVisibility() {
        ...
        boolean hideGhostModeShadow = sharedPreferences.getBoolean("hideGhostModeShadow", false);
        imageView.setVisibility(ghost_mpode && !hideGhostModeShadow ? View.VISIBLE : View.INVISIBLE);
    }


    public void createGhostModeImage() {
        this.ghostView = new ImageView(getContext());
        this.ghostView.setImageDrawable(getResources().getDrawable(R.drawable.ic_ghost_action));
