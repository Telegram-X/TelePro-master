    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        if (id == NotificationCenter.FileDidUpload) {
            ...
            if (uploadingAvatar != null && location.equals(uploadingAvatar)) {
                NotificationCenter.getInstance(UserConfig.selectedAccount).removeObserver(AvatarUpdater.this, NotificationCenter.FileDidUpload);
                NotificationCenter.getInstance(UserConfig.selectedAccount).removeObserver(AvatarUpdater.this, NotificationCenter.FileDidFailUpload);
                if (delegate != null) {
    ...
    private void processBitmap(Bitmap bitmap) {
        ...
        if (bigPhoto != null && smallPhoto != null) {
            if (returnOnly) {
                ...
                uploadingAvatar = FileLoader.getInstance(UserConfig.selectedAccount).getDirectory(FileLoader.MEDIA_DIR_CACHE) + "/" + bigPhoto.location.volume_id + "_" + bigPhoto.location.local_id + ".jpg";
                NotificationCenter.getInstance(UserConfig.selectedAccount).addObserver(AvatarUpdater.this, NotificationCenter.FileDidUpload);
                NotificationCenter.getInstance(UserConfig.selectedAccount).addObserver(AvatarUpdater.this, NotificationCenter.FileDidFailUpload);
                FileLoader.getInstance(UserConfig.selectedAccount).uploadFile(uploadingAvatar, false, true, ConnectionsManager.FileTypePhoto);
            }
        }
    }
